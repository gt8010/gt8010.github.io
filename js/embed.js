...
function sskadmin(e) {
    var ssk = '';
    if (e.user_id == 6381371213213598465) {
        if (checkMobile()) {
            ssk = '<span class="ua"><span class="sskadmin">博主大大</span></span><br><br>';
        } else {
            ssk = '<span class="ua"><span class="sskadmin">博主大大</span></span>';
        }
    } else {
        if (checkMobile()) {
            ssk = '<br><br>';
    ...
    !e.DUOSHUO) {
        ...
        var Z = {
            ...
            avatarUrl: function(e) {
                return e.avatar_url || 'http://ol5ro64tz.bkt.clouddn.com/header/105421J02-9.jpg?imageslim'
            },
